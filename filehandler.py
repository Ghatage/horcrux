...
class FileHandlingLayer(object):
	...
	def write_list_file(directory, filename, result):
	...
	def remove_files_from_dir(directory, pattern):
	...
	def check_if_lst_enc_files_exist(directory, listfile, enc2hashfile):
